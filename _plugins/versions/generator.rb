  ...
  class Generator
    ...
    def generate
      vps.each do |vp|
        ...
        page.data['canonical'] = page.data['canonical'] || stable_vp(vp.key)&.url || page.url
      ...
      # Disable symlink creation for stable and devel version aliases
    ...
    def versions
      @versions ||= Set.new(vps.map { |vp| vp.version })
        .to_a
        .compact
        .sort
        .reverse
