...
are APIs for this. The first one is [Cluster Health](http/cluster.html#queries-the-health-of-cluster-for-monitoring):
...
[`jq` JSON pretty printer](https://stedolan.github.io/jq/){:target="_blank"}:
