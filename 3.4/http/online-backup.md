...
with a given label within as soon as possible. The ambiguity in the
last sentence refers to the next window during which a global write
lock to all resources on a single server can be obtained in order to
