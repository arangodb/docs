...
and modules like the [`db` object](appendix-references-db-object.html) to
manage collections or run ad-hoc queries for instance, access the
[General Graph module](graphs-general-graphs-readme.html) or other features.
...
Commands like `curl` or invocations of [ArangoDB programs and tools](programs-readme.html)
