...
When deploying using the tool [_Starter_](deployment-arangodbstarter.html)
...
possible as well. See [Datacenter to datacenter replication](architecture-deploymentmodes-dc2dc.html)
