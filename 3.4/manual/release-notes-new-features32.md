...
Read more in the [overview](administration-managing-users-readme.html).
...
* it's now possible to provide your own version of the `graphql-sync` module when using the [GraphQL extensions for Foxx](foxx-reference-modules-graph-q-l.html) by passing a copy of the module using the new _graphql_ option.
