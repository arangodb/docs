...
[scorers](views-arangosearch-scorers.html), without impact on performance when specifying documents
...
[named analyzers](views-arangosearch-analyzers.html) which are merely aliases for type+configuration
...
- **analyzers** (_optional_; type: `array`; subtype: `string`; default: `[
  ...
  A list of analyzers, by name as defined via the [Analyzers](views-arangosearch-analyzers.html),
