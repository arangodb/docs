...
[SmartGraphs](graphs-smart-graphs-readme.html) that, if used while the database
...
1. Use the tool [_arangodump_](programs-arangodump-readme.html) to take a backup
...
4. Restore the backup using the tool [_arangorestore_](programs-arangorestore-readme.html).
