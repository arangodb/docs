...
- **RocksDB as Default Storage Engine**: With ArangoDB 3.4 the default
  [storage engine](architecture-storageengines.html) for fresh installations will
...
Also see [What's New in 3.4](releasenotes-newfeatures34.html).
...
- [**Server-level Replication**](administration-masterslave-serverlevelsetup.html):
...
- [**Vertex-centric indices**](indexing-vertexcentric.html):
...
- [**self-organizing cluster**](architecture-deploymentmodes-cluster-architecture.html) with
...
- Significantly improved [**Web Interface**](programs-webinterface.html)
