...
- Open the ArangoDB web UI and change the password from there. [More information](programs-webinterface-users.html).
- Open an ArangoSH shell and use the function _users.replace_. [More information](administration-managingusers-inarangosh.html#replace).
