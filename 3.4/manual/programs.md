...
|-----------------|-------------------|
| `arangod`       | [ArangoDB server](programs-arangod.html). This server program is intended to run as a daemon process / service to serve the various client connections to the server via TCP / HTTP. It also provides a [web interface](programs-webinterface.html).
...
|-----------------|-------------------|
| [Foxx CLI](programs-foxxcli.html) | Command line tool for managing and developing Foxx services
