...
or edge collection. 
See the [API descriptions for collection objects](datamodeling-documents-documentmethods.html) 
for details. Note that the [API for database objects](datamodeling-documents-databasemethods.html)
