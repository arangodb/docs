...
to speed-up the performance of [_arangorestore_](programs-arangorestore-readme.html)
in a Cluster environment.

It is assumed that a Cluster environment is running and a _logical_ backup
with [_arangodump_](programs-arangodump-readme.html) has already been taken.
