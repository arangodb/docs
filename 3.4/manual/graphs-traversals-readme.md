...
ArangoDB provides [several ways to query graph data](graphs-readme.html).
Very simple operations can be composed with the low-level edge methods *edges*, *inEdges*, and *outEdges* for
[edge collections](graphs-edges-readme.html). These work on named and anonymous graphs. For more complex operations,
