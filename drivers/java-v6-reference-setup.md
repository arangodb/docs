---
layout: default
description: Driver setup (version 6)
---
...
(see [example code](https://github.com/arangodb/arangodb-java-driver/blob/v6/src/test/java/com/arangodb/example/ssl/SslExampleTest.java){:target="_blank"}).
