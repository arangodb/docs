---
layout: default
description: Foxx does not provide any user management out of the box but it is very easy to roll your own solution
---
User management
===============
...
The [session middleware](foxx-sessions.html) provides mechanisms for adding session logic to your service, using e.g. a collection or JSON Web Tokens to store the sessions between requests.

The [auth module](foxx-auth.html) provides utilities for basic password verification and hashing.
