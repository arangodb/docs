---
layout: default
description: To dump data from an ArangoDB server instance, you will need to invoke arangodump
---
...
prototype is affected. [arangorestore](administration-arangorestore.html)
