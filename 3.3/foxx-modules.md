...
Additionally there are modules providing some level of compatibility with Node.js as well as a number of bundled NPM modules (like lodash and joi). For more information on these modules see [the JavaScript modules appendix](appendix-java-script-modules.html).
...
You can find a full description of this module [in the ArangoDB module appendix](appendix-java-script-modules-arango-db.html).
...
You can find a full description of this module [in the request module appendix](appendix-java-script-modules-request.html).
...
For more information see the [chapter on the general graph module](graphs-general-graphs.html).
