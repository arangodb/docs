...
* it's now possible to provide your own version of the `graphql-sync` module when using the [GraphQL extensions for Foxx](foxx-graph-ql.html) by passing a copy of the module using the new _graphql_ option.
