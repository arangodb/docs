---
layout: default
description: To export data from an ArangoDB server instance, you will need to invoke arangoexport
---
...
This exports the collection *test* into the output directory *export* as [jsonl](http://jsonlines.org){:target="_blank"}. Every line in the export is one document from the collection *test* as json.
...
[XGMML](https://en.wikipedia.org/wiki/XGMML){:target="_blank"} is an XML application based on
[GML](https://en.wikipedia.org/wiki/Graph_Modelling_Language){:target="_blank"}.
