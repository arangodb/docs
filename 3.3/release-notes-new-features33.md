...
[Encrypted backups](administration-arangodump.html#encryption) are available
...
3.3 adds [server-level replication](administration-replication-asynchronous-server-level-setup.html),
...
](https://www.arangodb.com/2017/10/milestone2-arangodb33-new-data-replication/#using-automatic-failover){:target="_blank"}
- [Introducing the new ArangoDB Java driver with load balancing and advanced fallback
](https://www.arangodb.com/2017/12/introducing-the-new-arangodb-java-driver-load-balancing/){:target="_blank"}
...
](https://www.arangodb.com/2017/11/rocksdb-smoothing-arangodb-customers/){:target="_blank"}
...
- basic role support has been added for the LDAP module in the *Enterprise* edition.
  ...
  Please refer to [LDAP](administration-configuration-ldap.html) for a detailed
  explanation.
