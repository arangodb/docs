...
{% docublock JSF_get_api_replication_logger_return_state %}
...
<!-- arangod/RestHandler/RestReplicationHandler.cpp -->
{% docublock JSF_get_api_replication_logger_returns %}
...
{% docublock JSF_get_api_replication_logger_first_tick %}
{% docublock JSF_get_api_replication_logger_tick_ranges %}
