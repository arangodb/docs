...
[increase the number of available V8 contexts](../administration-configuration-arangod.html#v8-contexts)
(at the expense of increased memory usage),
and [the number of available server threads](../administration-configuration-arangod.html#server-threads).
