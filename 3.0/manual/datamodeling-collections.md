...
from the user perspective, the [collection name](appendix-glossary.html#collection-name) should be used, i.e.:

### Collection
`db._collection(collection-name)`

A collection is created by a ["db._create"](datamodeling-collections-databasemethods.html) call.
...
This method is a database method and is documented in detail at [Database Methods](datamodeling-collections-databasemethods.html#create)
...
[Scalability](scalability.html) for details of the ArangoDB
...
[Database Methods](datamodeling-collections-databasemethods.html#create).
