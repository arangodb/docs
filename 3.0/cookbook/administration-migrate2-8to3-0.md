...
[in the manual](https://docs.arangodb.com/3.0/Manual/Administration/Upgrading/Upgrading30.html){:target="_blank"}.
...
[this page](https://docs.arangodb.com/3.0/Manual/Administration/Arangorestore.html){:target="_blank"}
