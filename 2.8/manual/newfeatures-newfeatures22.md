...
[Data modification queries](aql-datamodification.html).
...
For the configuration of the write-ahead log, please refer to [Write-ahead log options](configurearango-wal.html).
