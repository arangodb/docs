...
ArangoDB 2.8. Please be sure that you have checked the list of [changes in 2.8](upgrading-upgradingchanges28.html)
before upgrading.
...
ArangoDB and Foxx [has changed](upgrading-upgradingchanges28.html#module-resolution)
