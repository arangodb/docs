---
layout: default
description: To use a traversal object, we first need to require the traversal module
---
Getting started
===============
...
[edge collection](glossary.html#edge-collection) specified in the traversal configuration.
