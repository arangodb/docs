---
layout: default
description: Sharding allows to use multiple machines to run a cluster of ArangoDBinstances that together constitute a single database
---
Sharding
========
...
page](https://github.com/coreos/etcd){:target="_blank"}). It provides a hierarchical
