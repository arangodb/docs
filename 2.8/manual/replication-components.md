...
(see [HTTP Interface for Replication](httpreplications.html)).
...
**Note**: The replication logger state can also be queried via the [HTTP API](httpreplications.html).
...
Please refer to [HTTP Interface for Replication](httpreplications.html) for more details.
