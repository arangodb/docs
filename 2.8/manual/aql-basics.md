...
Please refer to the [Naming Conventions in ArangoDB](namingconventions-collectionnames.html) about collection naming
conventions.
...
Please refer to the [Naming Conventions in ArangoDB](namingconventions-attributenames.html) for more information about the
...
[to use string functions to do so](aql-stringfunctions.html):
