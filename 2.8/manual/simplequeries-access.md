...
{% docublock cursorHasNext %}

### Next
<!-- js/common/modules/org/arangodb/simple-query-common.js -->
{% docublock cursorNext %}

### Set Batch size
<!-- js/common/modules/org/arangodb/simple-query-common.js -->
{% docublock cursorSetBatchSize %}

### Get Batch size
<!-- js/common/modules/org/arangodb/simple-query-common.js -->
{% docublock cursorGetBatchSize %}

### Execute Query
<!-- js/common/modules/org/arangodb/simple-query-common.js -->
{% docublock queryExecute %}

### Dispose
<!-- js/common/modules/org/arangodb/simple-query-common.js -->
{% docublock cursorDispose %}

### Count
<!-- js/common/modules/org/arangodb/simple-query-common.js -->
{% docublock cursorCount %}