---
layout: default
description: The ArangoDB contains a wrapper for jsUnity, alightweight universal JavaScript unit testing framework
---
...
The ArangoDB contains a wrapper for [jsUnity](http://jsunity.com/){:target="_blank"}, a
