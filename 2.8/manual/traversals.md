...
Please read the [chapter about AQL traversersals](aql-graphtraversals.html) before you continue reading here.
...
populated with continents, countries and capitals data listed below (see [Example Data](traversals-exampledata.html)).
