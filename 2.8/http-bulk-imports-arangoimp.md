...
It is possible to import [document keys](glossary.html#document-key) with the documents using the *_key*
attribute. When importing into an [edge collection](glossary.html#edge-collection), it is mandatory that all
