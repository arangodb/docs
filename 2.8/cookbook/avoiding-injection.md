...
bundled with ArangoDB). Inside ArangoDB, there are also [Foxx queries](https://docs.arangodb.com/Foxx/Develop/Queries.html){:target="_blank"}
...
Bind parameter names are automatically generated by the `aqlQuery` function:
