...
## Solution
Since arangodb [reports the replication status in JSON](https://docs.arangodb.com/HttpReplications/ReplicationApplier.html#state-of-the-replication-applier){:target="_blank"},
integrating it with the [collectd curl_JSON plugin](monitoring-with-collectd.html)
