...
**Note:** For this recipe you need at least Arango 2.4. For versions before look at the [old My first Foxx App](foxx-first-steps-legacy.html).
...
*Don't have ArangoDB installed yet? Check out the instructions [on our downloads page](https://www.arangodb.com/download){:target="_blank"}.*
