---
layout: default
description: All collections specified in the collections attribute are locked in therequested mode (read or write) at transaction start
---
...
inside the transaction, for example a query using AQL graph functions.
