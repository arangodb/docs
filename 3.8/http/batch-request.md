...
To send multiple documents at once to an ArangoDB instance, please use
the [HTTP Interface for Documents](http/document.html), which can handle
arrays of documents to insert, update, replace, remove.
{% endhint %}
