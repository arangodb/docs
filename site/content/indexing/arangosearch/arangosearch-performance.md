...
See the [`storedValues` View property](arangosearch-views#view-properties)
for details.
...
Also see the [`SEARCH` operation](../../aql/high-level-operations/operations-search#search-options).
