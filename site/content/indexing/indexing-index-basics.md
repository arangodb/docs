...
for the [document keys](../appendix/appendix-glossary#document-key) (`_key` attribute)
...
Every [edge collection](../appendix/appendix-glossary#edge-collection) also has an 
...
## Indexing attributes and subattributes
