...
When deploying using the tool [_Starter_](../../../deployment/by-technology/deployment-arango-dbstarter)
...
[_Cluster Sharding_](architecture-deployment-modes-cluster-sharding) section.
...
- If you want your entire cluster to be a OneShard deployment, use the
  [startup option](../../../programs-tools/arangodb-server/options/#cluster)
...
See the [Cluster Deployment](../../../deployment/by-arangodb-deployment-modes/cluster/)
