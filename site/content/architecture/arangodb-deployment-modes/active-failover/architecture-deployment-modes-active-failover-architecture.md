---
fileID: architecture-deployment-modes-active-failover-architecture
title: Active Failover Architecture
weight: 950
description: 
layout: default
---
...
replication and failover [out of the box](../../../deployment/by-arangodb-deployment-modes/active-failover/deployment-active-failover-using-the-starter).
