...
{{% enterprise-tag feature="The arangobackup tool and the Hot Backup API" arangograph="true" %}}
...
- **Known Issues**
  ...
  See the list of [Known Issues](../release-notes/version-3.10/release-notes-known-issues310#hot-backup).
