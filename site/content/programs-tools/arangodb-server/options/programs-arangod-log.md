---
fileID: programs-arangod-log
title: ArangoDB Server Log Options
weight: 280
description: 
layout: default
---
...
See [Log Levels](../../../monitoring/monitoring-log-levels) in the Monitoring chapter for a
...
See more [log levels](../../../http/administration-monitoring/#modify-and-return-the-current-server-log-level)
...
[--audit.max-entry-length](programs-arangod-audit#maximum-line-length)
instead.
{{% /hints/info %}}
...
<small>Introduced in: v3.5.6, v3.6.5, v3.7.1</small>
