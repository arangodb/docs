---
fileID: programs-arangod-cluster
title: ArangoDB Server Clusters Options
weight: 245
description: 
layout: default
---
...
**Rebalance Shards** button is clicked in the web interface. For backwards compatibility
...
[Rebalance Shards](../../web-interface/programs-web-interface-cluster#rebalance-shards).
...
Also see:
- [Database HTTP API](../../../http/databases/database-database-management#create-database)
- [Collection HTTP API](../../../http/collections/collection-creating#create-collection)
