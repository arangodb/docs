...
to the [_Cluster Architecture_](#synchronous-replication) section. 
...
- [`--cluster.min-replication-factor`](../../programs-tools/arangodb-server/programs-arangod-options#--clustermin-replication-factor)
- [`--cluster.max-replication-factor`](../../programs-tools/arangodb-server/programs-arangod-options#--clustermax-replication-factor)

The default replication factor for regular and for system collections is defined
by the following startup options:

- [`--cluster.default-replication-factor`](../../programs-tools/arangodb-server/programs-arangod-options#--clusterdefault-replication-factor)
- [`--cluster.system-replication-factor`](../../programs-tools/arangodb-server/programs-arangod-options#--clustersystem-replication-factor)
