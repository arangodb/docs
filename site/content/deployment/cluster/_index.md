---
fileID: architecture-deployment-modes-cluster-architecture
...
possible as well. See [Datacenter-to-Datacenter Replication](../../arangosync/deployment/)
...
[_Cluster Sharding_](../../architecture/architecture-deployment-modes-cluster-sharding) section.
...
- If you want your entire cluster to be a OneShard deployment, use the
  [startup option](../../programs-tools/arangodb-server/programs-arangod-options#cluster)
...
- The AQL query or [Stream Transaction](../../http/transactions/transaction-stream-transaction)
...
[`--cluster.min-replication-factor` startup option](../../programs-tools/arangodb-server/programs-arangod-options#--clustermin-replication-factor).
...
1. Connect to a _Coordinator_ via [_arangosh_](../../programs-tools/arangodb-shell/)
...
[Foxx services](../../foxx-microservices/) it is very easy to deploy a data
...
[_Starter_](../../programs-tools/arangodb-starter/), in Docker and in Kubernetes.

See the [Cluster Deployment](deployment/)
