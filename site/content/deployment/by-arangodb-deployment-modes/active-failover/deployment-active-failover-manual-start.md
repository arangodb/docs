---
fileID: deployment-active-failover-manual-start
...
Before continuing, be sure to read the [Architecture](../../../architecture/arangodb-deployment-modes/active-failover/architecture-deployment-modes-active-failover-architecture)
