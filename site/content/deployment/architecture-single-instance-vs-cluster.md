---
fileID: architecture-single-instance-vs-cluster
...
[AQL WITH operation](../aql/high-level-operations/operations-with)
...
competing database systems. See [Transactions](../transactions/)
for details.
...
`arangobackup` and an HTTP API for [Hot Backups](../backup-restore/#hot-backups)
