...
For string concatenation, you must use the [string function](functions/functions-string#concat)
...
[evaluation of subqueries](examples-query-patterns/examples-combining-queries#evaluation-of-subqueries).
{{% /hints/info %}}
...
[array variable expansion](advanced-features/advanced-array-operators#array-expansion) and
