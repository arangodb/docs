...
See [Kubernetes Deployment Resource](../deployment/by-technology/kubernetes/deployment-kubernetes-deployment-resource#specrocksdbencryptionkeysecretname).
...
[HTTP API](../http/administration-monitoring/#encryption-at-rest). This API
