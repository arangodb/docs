...
See [Graph traversal options](../../graphs/traversals/#working-with-named-graphs)

### AQL functions added

The following AQL functions have been added in ArangoDB 3.7:

- [IN_RANGE()](../../aql/functions/functions-miscellaneous#in_range)
  (now available outside of `SEARCH` operations)
- [INTERLEAVE()](../../aql/functions/functions-array#interleave)
- [IPV4_FROM_NUMBER()](../../aql/functions/functions-string#ipv4_from_number)
- [IPV4_TO_NUMBER()](../../aql/functions/functions-string#ipv4_to_number)
- [IS_IPV4()](../../aql/functions/functions-string#is_ipv4)
- [JACCARD()](../../aql/functions/functions-array#jaccard)
...
- [PRODUCT()](../../aql/functions/functions-numeric#product)
- [REPLACE_NTH()](../../aql/functions/functions-array#replace_nth)
...
Improved the lazy evaluation capabilities of the [ternary operator](../../aql/operators#ternary-operator).
...
See: [Schema Validation](../../getting-started/data-model-concepts/documents/data-modeling-documents-schema-validation)
...
See: [HTTP Switching Protocols](../../http/general#switching-protocols)
...
This allows [rotation of TLS keys and certificates](../../http/administration-monitoring/#tls)
without a server restart.

### Encryption at rest key rotation (Enterprise Edition)

It is possible to change the user supplied encryption key via the
[HTTP API](../../http/administration-monitoring/#encryption-at-rest)
...
The query options are available in [AQL](../../aql/high-level-operations/operations-insert#query-options),
the [JS API](../../getting-started/data-model-concepts/documents/data-modeling-documents-document-methods#insert--save) and
[HTTP API](../../http/documents/document-working-with-documents#create-document).
...
See [ArangoDB Server Environment Variables](../../programs-tools/arangodb-server/programs-arangod-env-vars)
...
Also see [Pregel](../../data-science/pregel/)
...
on `/_admin/metrics`.
See [Metrics HTTP API](../../http/administration-monitoring/administration-and-monitoring-metrics).
...
Also see:
- [Troubleshooting _arangod_](../../troubleshooting/troubleshooting-arangod#other-crashes)
- [Server environment variables](../../programs-tools/arangodb-server/programs-arangod-env-vars)
