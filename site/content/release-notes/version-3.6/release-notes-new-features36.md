...
[OneShard cluster architecture](../../deployment/cluster/#oneshard)
...
- [Collection names](../../getting-started/data-model-concepts/naming-conventions/data-modeling-naming-conventions-collection-and-view-names)
