...
## Datacentertodatacenter replication (DC2DC)
...
[Encrypted backups](../../programs-tools/arangodump/programs-arangodump-examples#encryption) are available
in the *Enterprise Edition*.

## Serverlevel replication
