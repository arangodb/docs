...
See: [Graph Traversal Pruning](../../graphs/traversals/#pruning)
...
Also see:
- [AQL Optimizer Rules](../../aql/execution-and-performance/execution-and-performance-optimizer#list-of-optimizer-rules)
  (`sort-limit` rule)
...
See:
- [AQL Index Hints](../../aql/high-level-operations/operations-for#indexhint)
...
Also see: [AQL Numeric Literals](../../aql/aql-fundamentals/fundamentals-data-types#numeric-literals)
...
See: [AQL k Shortest Paths](../../aql/graphs/graphs-kshortest-paths)
...
Also see:
- [SmartJoins documentation](../../smartjoins/)
...
Also see: [Creating Indexes in Background](../../indexing/indexing-index-basics#creating-indexes-in-background)
...
Also see: [TTL Indexes](../../indexing/working-with-indexes/indexing-ttl)
...
Also see: [Collection Database Methods](../../getting-started/data-model-concepts/collections/data-modeling-collections-database-methods#create)
...
See:
- [Get responsible shard in JS API](../../getting-started/data-model-concepts/collections/data-modeling-collections-collection-methods#getresponsibleshard)
- [Get responsible shard in HTTP API](../../http/collections/collection-getting#return-responsible-shard-for-a-document)
...
[Known Issues](release-notes-known-issues35#stream-transactions)

See: [Stream Transaction HTTP API](../../http/transactions/transaction-stream-transaction)
...
[Security Options](../../security/security-security-options).
...
Also see:
- [_arangodump_](../../programs-tools/arangodump/)
