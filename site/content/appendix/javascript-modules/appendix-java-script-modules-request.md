...
* *sslProtocol* (optional): which tls version should be used to connect to the url. The default is `4` which is TLS 1.0. See [SSL protocol](../../programs-tools/arangodb-server/options/programs-arangod-ssl#ssl-protocol) for more opitions.
