---
fileID: tutorials-reduce-memory-footprint
...
reduce these [RocksDB settings](../programs-tools/arangodb-server/options/programs-arangod-rocksdb):
...
Also see:
- [RocksDB Server Options](../programs-tools/arangodb-server/options/#rocksdb)
...
This option disables the in-memory index [caches](../programs-tools/arangodb-server/options/programs-arangod-cache).
...
The server collects
[statistics](../programs-tools/arangodb-server/options/programs-arangod-server#toggling-server-statistics) regularly,
...
[JavaScript](../programs-tools/arangodb-server/options/programs-arangod-javascript) is executed in the ArangoDB
...
Also see [Preventing cluster overwhelm](../programs-tools/arangodb-server/options/programs-arangod-server#preventing-cluster-overwhelm).
