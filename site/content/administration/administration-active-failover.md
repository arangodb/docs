...
to the _Active Failover_ [chapter](../architecture/arangodb-deployment-modes/active-failover/).
...
into our [deployment guide](../deployment/by-arangodb-deployment-modes/active-failover/).
