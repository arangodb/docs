...
[arangosh](administration-managing-users-in-arangosh), as well as via the
[HTTP API](../../http/user-management).
...
Access levels can be managed via the [web interface](../../programs-tools/web-interface/programs-web-interface-users)
or in [arangosh](administration-managing-users-in-arangosh).
