...
[Distributed Iterative Graph Processing (Pregel)](pregel/)
...
- [Page Rank](pregel/graphs-pregel-algorithms#pagerank): used for ranking documents in a graph
  search/traversal.
- [Single-Source Shortest Path](pregel/graphs-pregel-algorithms#single-source-shortest-path): calculates
  the shortest path length between the source and all other vertices.
  For example, _How to get from a to b_?
- [Hyperlink-Induced Topic Search (HITS)](pregel/graphs-pregel-algorithms#hyperlink-induced-topic-search-hits): 
  a link analysis algorithm that rates web pages.
- [Vertex Centrality](pregel/graphs-pregel-algorithms#vertex-centrality): identifies the most important
  nodes in a graph. For example, _Who are the influencers in a social network?_
- [Community Detection](pregel/graphs-pregel-algorithms#community-detection): identifies distinct subgroups
