...
Should a transaction involve [Leader Shards](../architecture/arangodb-deployment-modes/cluster/architecture-deployment-modes-cluster-architecture#db-servers) 
