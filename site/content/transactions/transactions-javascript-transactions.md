...
[Transactions Locking](transactions-locking-and-isolation) for more details.
...
See the [HTTP Interface for JavaScript Transactions](../http/transactions/transaction-js-transaction)
documentation.
