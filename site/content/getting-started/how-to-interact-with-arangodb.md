---
fileID: how-to-interact-with-arangodb
...
The core component of ArangoDB is the [ArangoDB server](../programs-tools/arangodb-server/)
...
[web interface](../programs-tools/web-interface/). The ArangoDB server serves this
...
You can use [arangosh](../programs-tools/arangodb-shell/), an interactive shell that ships
with ArangoDB, and its [JavaScript API](../appendix/references/appendix-references-dbobject), to
