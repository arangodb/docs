...
```js
db.imdb_vertices.ensureIndex({ type: "inverted", name: "inv-text", fields: [ { name: "title", analyzer: "text_en" } ] });
...
```js
db.imdb_vertices.ensureIndex({ type: "inverted", name: "inv-ngram", fields: [ { name: "title", analyzer: "edge_ngram" } ] });
