...
1. Download [dump.zip](https://github.com/arangodb-foxx/demo-geo-s2/archive/refs/heads/dump.zip){:target="_blank"} (2.2 MB)
2. Unpack the downloaded archive
...
4. Create a View called `restaurantsView` in the `GeoS2` database.
   ...
   [Geospatial Search with ArangoSearch](arangosearch-geospatial-search.html).
