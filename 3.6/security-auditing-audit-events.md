...
This message will occur whenever a user attempts to create a hotbackup. If
successful, the status will read `0`, otherwise some numerical error
code.
...
This message will occur whenever a user attempts to restores from a
hotbackup. If successful, the status will read `0`, otherwise some
numerical error code.

### Deleting a hotbackup
...
This message will occur whenever a user attempts to delete a
hotbackup. If successful, the status will read `0`, otherwise some
numerical error code.
