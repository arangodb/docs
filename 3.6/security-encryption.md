...
If you are using Kube-ArangoDB please use the [`spec.rocksdb.encryption.keySecretName` 
setting](https://www.arangodb.com/docs/stable/deployment-kubernetes-deployment-resource.html#specrocksdbencryptionkeysecretname) for specifying the encryption key.  
