...
| **Date Added:** 2020-01-07 <br> **Component:** AQL <br> **Deployment Mode:** All <br> **Description:** It is not possible to execute AQL traversals using collection sets (anonymous graph) for datasets where edges point to other edges. <br> **Affected Versions:** 3.6.x <br> **Fixed in Versions:** - <br> **Reference:** N/A |
