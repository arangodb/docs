...
| **Date Added:** 2020-06-19 <br> **Component:** SmartGraphs **Deployment Mode:** Cluster <br> **Description:** When inserting edges into an edge collection of a SmartGraph, the auto-generated `_rev` values for the ingoing and outgoing part of the edge may differ. This can be confusing when querying the `_rev` values of the edges later. <br> **Affected Versions:** 3.4.x, 3.5.x, 3.6.0 - 3.6.4, 3.7.0 <br> **Fixed in Versions:** 3.6.5, 3.7.1 <br> **Reference:** N/A |
