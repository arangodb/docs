...
| **Date Added:** 2019-11-06 <br> **Component:** arangod <br> **Deployment Mode:** All <br> **Description:** Upgrades from ArangoDB version 3.4.x to 3.5.0 or 3.5.1 don't create `_analyzers` collection and leaves no possibility to create and use custom analyzers. Suggested workaround: create system collection named `_analyzers` in each database of ArangoDB deployment after upgrade. <br> **Affected Versions:** 3.5.0, 3.5.1 <br> **Fixed in Versions:** 3.5.2 <br> **Reference:** [arangodb/backlog#652](https://github.com/arangodb/backlog/issues/652){:target="_blank"} (internal) |
