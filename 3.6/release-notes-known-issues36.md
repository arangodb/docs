...
| **Date Added:** 2019-12-10 <br> **Component:** Installer <br> **Deployment Mode:** All <br> **Description:** The NSIS installer for Windows may fail to upgrade an existing installation, e.g. from 3.5.3 to 3.6.0, with the error message: <blockquote>failed to detect whether we need to Upgrade:<br>&gt;&gt; exit with error &lt;&lt;<br>"Will be returned when a general error occurred.</blockquote> <br> **Affected Versions:** 3.5.x, 3.6.x <br> **Fixed in Versions:** - <br> **Reference:** [arangodb/release-qa#183](https://github.com/arangodb/release-qa/issues/183){:target="_blank"} (internal) |
...
| **Date Added:** 2019-12-10 <br> **Component:** Web UI <br> **Deployment Mode:** All <br> **Description:** Some elements in the interface are misaligned or overlap with other elements. <br> **Affected Versions:** 3.6.0-rc.1 <br> **Fixed in Versions:** - <br> **Reference:** [arangodb/release-qa#184](https://github.com/arangodb/release-qa/issues/184){:target="_blank"} (internal) |
| **Date Added:** 2019-12-10 <br> **Component:** HTTP API <br> **Deployment Mode:** Cluster <br> **Description:** The endpoint `/_admin/cluster/rebalanceShards` does not allow to rebalance shards of a database other than `_system`. This issue was fixed for 3.5, but not ported to 3.6. <br> **Affected Versions:** 3.6.0-rc.1 <br> **Fixed in Versions:** 3.5.3 <br> **Reference:** [arangodb/arangodb#10668](https://github.com/arangodb/arangodb/pull/10668){:target="_blank"} |
| **Date Added:** 2019-12-10 <br> **Component:** Installer <br> **Deployment Mode:** All <br> **Description:** The DMG package for macOS is unnotarized, which prevents the execution of _ArangoDB3-CLI.app_ under macOS 10.15 (Catalina) with error message: <blockquote>"ArangoDB3-CLI" can't be opened because Apple cannot check it for malicious software.</blockquote> <br> **Affected Versions:** 3.3.x, 3.4.x, 3.5.x, 3.6.0-rc.1 <br> **Fixed in Versions:** - <br> **Reference:** [arangodb/arangodb#10561](https://github.com/arangodb/arangodb/issues/10561){:target="_blank"} |
| **Date Added:** 2019-12-10 <br> **Component:** OneShard <br> **Deployment Mode:** Cluster <br> **Description:** Collections can be created in OneShard databases with a replication factor higher than the allowed maximum (number of currently present DB-Servers), effectively ignoring the `enforceReplicationFactor` option. <br> **Affected Versions:** 3.6.0-rc.1 <br> **Fixed in Versions:** - <br> **Reference:** [arangodb/arangodb#10655](https://github.com/arangodb/arangodb/pull/10655){:target="_blank"} |
