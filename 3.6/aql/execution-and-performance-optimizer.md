...
- `move-calculations-up`: will appear if a *CalculationNode* was moved up in a plan.
  ...
  to kick in.
- `move-filter-into-enumerate`: moves filters on non-indexed
  collection attributes into *IndexNode* or *EnumerateCollectionNode*
  to allow early pruning of non-matching documents.
