...
| **Date Added:** 2020-05-22 <br> **Component:** ArangoSearch <br> **Deployment Mode:** Cluster <br> **Description:** Immediate recreation of ArangoSearch analyzer in cluster deployments (deleting and immediate creation with the same name but different properties) will cause error during the query execution which involves recreated analyzed. <br> **Affected Versions:** 3.5.x, 3.6.x, 3.7.0, 3.7.0.1 <br> **Fixed in Versions:** 3.7.1-alpha.2 <br> **Reference:** [arangodb/backlog#669](https://github.com/arangodb/backlog/issues/669){:target="_blank"} (internal), [arangodb/backlog#695](https://github.com/arangodb/backlog/issues/695){:target="_blank"} (internal) |
