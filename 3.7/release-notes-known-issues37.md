...
| **Date Added:** 2019-03-17 <br> **Component:** Schema Validation <br> **Deployment Mode:** All <br> **Description:** Validation schemas using `"additionalProperties": false` need to describe system attributes: `_key`, `_id`, `_rev` as well as `_from` and `_to` for edge collections. Otherwise documents will always be considered invalid. **Affected Versions:** 3.7.0-alpha.2 <br> **Fixed in Versions:** - <br> **Reference:** N/A |
