...
Foxx Controllers have been replaced with [routers](foxx-reference-routers.html). This is more than a cosmetic change as there are significant differences in behavior:
