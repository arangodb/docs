...
After you stopped the _Starter_ make sure the `arangod` processes it spawned are still running;
they now will be re-parented to the systemd or init process:
