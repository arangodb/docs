...
* vertexExample1 (optional) See [Definition of examples](graphs-generalgraphs-functions.html#definition-of-examples)
* vertexExample2 (optional) See [Definition of examples](graphs-generalgraphs-functions.html#definition-of-examples)
* options (optional) An object defining further options. Can have the following values:
  * *edgeExamples*: Filter the edges, see [Definition of examples](graphs-generalgraphs-functions.html#definition-of-examples)
