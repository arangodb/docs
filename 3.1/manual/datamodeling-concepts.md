...
The [web interface](administration-webinterface.html) that comes with
ArangoDB, called *Aardvark*, provides graphical user interface that is easy to use.
An [interactive shell](gettingstarted-arangosh.html), called *Arangosh*, is also
...
such as [hash indexes]indexing-hash.html and [geo indexes](indexing-geo.html).
