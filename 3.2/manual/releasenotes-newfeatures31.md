...
graph operations.
For more detailed information read [this manual section](graphs-smartgraphs.html).
...
It is now easy to get started with providing GraphQL APIs in Foxx, see [Foxx GraphQL](foxx-graphql.html).
