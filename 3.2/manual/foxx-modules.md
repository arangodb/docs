...
Additionally there are modules providing some level of compatibility with Node.js as well as a number of bundled NPM modules (like lodash and joi). For more information on these modules see [the JavaScript modules appendix](appendix-javascriptmodules.html).
...
You can find a full description of this module [in the ArangoDB module appendix](appendix-javascriptmodules-arangodb.html).
...
You can find a full description of this module [in the request module appendix](appendix-javascriptmodules-request.html).
...
For more information see the [chapter on the general graph module](graphs-generalgraphs.html).
