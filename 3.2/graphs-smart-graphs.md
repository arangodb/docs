...
[AQL Graph Operations](aql/graphs.html) and
[Graph Functions](graphs-general-graphs-functions.html) sections.
...
This switch can be easily achieved with [arangodump](administration-arangodump.html)
and [arangorestore](administration-arangorestore.html).
