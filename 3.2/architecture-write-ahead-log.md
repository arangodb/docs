---
layout: default
description: The Write-ahead log is part of the MMFiles storage engine; This doesn't apply to yourArangoDB if you are running with the RocksDBstorage engine
---
Write-ahead log
===============
The Write-ahead log is part of the MMFiles storage engine; This doesn't apply to your
ArangoDB if you are running with the [RocksDB](administration-configuration-rocks-db.html)
storage engine.
