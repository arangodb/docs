...
When deploying using the tool [_Starter_](deployment-arango-db-starter-readme.html)
...
possible as well. See [Datacenter to datacenter replication](architecture-deployment-modes-dc2dc-readme.html)
...
1. Connect to a _Coordinator_ via [_arangosh_](programs-arangosh-readme.html)
...
[Foxx services](foxx-readme.html) it is very easy to deploy a data
...
[_Starter_](programs-starter-readme.html), in
Docker, in Mesos or DC/OS, and in Kubernetes.

See the [Cluster Deployment](deployment-cluster-readme.html)
