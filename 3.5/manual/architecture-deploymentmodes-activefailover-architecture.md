...
The advantage of the _Active Failover_ compared to the traditional [_Master/Slave_](architecture-deploymentmodes-masterslave.html)
...
[Database users](administration-managingusers.html)
...
(DC2DC) among ArangoDB Clusters. See [DC2DC](architecture-deploymentmodes-dc2dc.html) chapter for details.
{% endhint %}
...
replication and failover [out of the box](deployment-activefailover-usingthestarter.html).
