...
The [web interface](programs-web-interface-readme.html) that comes with
ArangoDB, called *Aardvark*, provides graphical user interface that is easy to use.
An [interactive shell](programs-arangosh-readme.html), called *Arangosh*, is also
...
[View](data-modeling-views-readme.html) in its simplest form can be seen as a read-only
