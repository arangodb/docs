...
- [JavaScript General Graph implementation, as you may use it in Foxx Services](graphs-general-graphs-readme.html)
...
- [JavaScript Smart Graph implementation, for scalable graphs](graphs-smart-graphs-readme.html)
...
You may use anonymous graphs in the [traversals](graphs-traversals-readme.html) 
and in the [Working with Edges](graphs-edges-readme.html) chapter.
...
For sure you want to have backups of your graph data, you can use [Arangodump](programs-arangodump-readme.html) to create the backup,
and [Arangorestore](programs-arangorestore-readme.html) to restore a backup into a new ArangoDB. You should however note that:
