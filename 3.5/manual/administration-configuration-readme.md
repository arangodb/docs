...
The [programs and tools](programs-readme.html) shipped in an
...
respective [Programs & Tools](programs-readme.html) sub-chapter, like the
[ArangoDB Server Options](programs-arangod-options.html).

The [ArangoDB Starter](programs-starter-readme.html) works differently
...
connect with an [ArangoShell](programs-arangosh-readme.html) and invoke a
