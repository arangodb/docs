...
- Should you be using the [ArangoDB Starter](programs-starter-readme.html) 
  or the [Kubernetes Operator](deployment-kubernetes-readme.html) to manage your Active-Failover
