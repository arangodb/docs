...
This chapter describes the [smart-graph](graphs-readme.html) module.
...
This switch can be easily achieved with [arangodump](programs-arangodump-readme.html)
and [arangorestore](programs-arangorestore-readme.html).
