...
The advantage of the _Active Failover_ compared to the traditional [_Master/Slave_](architecture-deployment-modes-master-slave-readme.html)
...
[Database users](administration-managing-users-readme.html)
...
(DC2DC) among ArangoDB Clusters. See [DC2DC](architecture-deployment-modes-dc2dc-readme.html) chapter for details.
{% endhint %}
