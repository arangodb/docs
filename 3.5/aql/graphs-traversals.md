---
layout: default
description: There are two slightly different syntaxes for traversals in AQL, one for
---
...
The following examples are based on the [traversal graph](../manual/graphs.html#the-traversal-graph).
