...
| **Date Added:** 2019-11-06 <br> **Component:** ArangoSearch <br> **Deployment Mode:** Cluster <br> **Description:** There is a possibility to get into deadlock during Coordinator execution if any `custom analyzer` was created (and is present in `_analyzers` collection). It's recommended not to use `custom analyzers` in production environment. <br> **Affected Versions:** 3.5.x <br> **Fixed in Versions:** - <br> **Reference:** [arangodb/backlog#651] |
