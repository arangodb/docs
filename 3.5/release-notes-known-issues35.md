...
| **Date Added:** 2019-11-06 <br> **Component:** arangod <br> **Deployment Mode:** Cluster <br> **Description:** Rolling upgrade of cluster from 3.5.x to 3.5.(x+1) is not possible due to error at DBServer. <br> **Affected Versions:** 3.5.0, 3.5.1 <br> **Fixed in Versions:** 3.5.2 <br> **Reference:** [arangodb/backlog#652] |
