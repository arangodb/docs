...
| **Date Added:** 2019-12-10 <br> **Component:** Installer <br> **Deployment Mode:** All <br> **Description:** The NSIS installer for Windows may fail to upgrade an existing installation, e.g. from 3.5.3 to 3.6.0, with the error message:<br>&gt; failed to detect whether we need to Upgrade:<br>&gt; &gt;&gt; exit with error &lt;&lt;<br>&gt;"Will be returned when a general error occurred. <br> **Affected Versions:** 3.5.x, 3.6.x <br> **Fixed in Versions:** - <br> **Reference:** [arangodb/release-qa#183](https://github.com/arangodb/release-qa/issues/183){:target="_blank"} (internal) |
