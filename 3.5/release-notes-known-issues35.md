...
| **Date Added:** 2019-05-24 <br> **Component:** Web UI <br> **Deployment Mode:** All <br> **Description:** The Logs section in the web interface does not work in the current pre-releases. <br> **Affected Versions:** 3.5.0-RC.x <br> **Fixed in Versions:** - <br> **Reference:** N/A |
